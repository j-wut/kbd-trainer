...
#define INITIAL_VIEW_WIDTH (ICON_WIDTH/2 + SIDE_PADDING + ACC_DISPLAY_WIDTH + ICON_WIDTH + SCORE_COUNTER_WIDTH + (SIDE_PADDING * 3))
#define INITIAL_VIEW_HEIGHT (ICON_HEIGHT * 3 + VERT_PADDING * 3)
